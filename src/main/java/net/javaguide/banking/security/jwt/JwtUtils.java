package net.javaguide.banking.security.jwt;
...
public class JwtUtils {
  ...
  @Value("${net.javaguide.banking.jwtSecret}")
  private String jwtSecret;

  @Value("${net.javaguide.banking.jwtExpirationMs}")
  private int jwtExpirationMs;

  @Value("${net.javaguide.banking.jwtCookieName}")
